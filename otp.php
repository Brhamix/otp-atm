    	...
    	<div class="row">
    		...
    		<div class="col-md-6">
    			<div style="text-align: center;" class="login-box">
    				<br><br>
    				<h3 style="color: #fff;">
    					<br>Please enter your 4 digit OTP code to Complete Transaction.
                    </h3>
                    <br><br>
                    <div style="text-align: center;" id="otp-stat"></div>
                   ...
                   &nbsp;<a href=""><button class="btn btn-danger" style="font-size: 25px; width: 110px;">Clear</button></a> &nbsp;<button onclick="return validateOtp()" class="btn btn-success" style="font-size: 25px; width: 110px;">Proceed</button>
    			</div>
    		</div>
    		<div class="col-md-2"></div>
    		<div class="col-md-1"></div>
