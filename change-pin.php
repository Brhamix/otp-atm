...
<body style="background-color: #404040;">
    ...
    <div class="container">
    	<div class="row">
            ...
            <div class="col-md-6">
                <div id="menu" style="text-align: center;" class="login-box">
                    <div id="stat"></div>
                    <br><br><br><br>
                    <h2 style="color: #fff;">Welcome <?= '<span style="color: green;">'.$_SESSION['name'].'</span>'; ?>
                        <br>Please enter your new pin to proceed.
                    </h2>
                    <br><br>
                   ...
                   &nbsp;<a href=""><button class="btn btn-danger" style="font-size: 25px; width: 110px;">Clear</button></a> &nbsp;<button onclick="return changePin()" class="btn btn-success" style="font-size: 25px; width: 110px;">Proceed</button>
    			</div>
    		</div>
    		<div class="col-md-2"></div>
    		<div class="col-md-1"></div>
