  ...
  <div class="container">
  	<div class="row">
  		...
  		<br><br><br><br>
            ...
            <br><br>
             		<h4 style="color: #fff;">Welcome to Online Automated Teller Machine</h2>
             		<br>
                	 <h4 style="color: #fff;">Enter your ATM Card last 4 digits to proceed</h4>
                	 <hr>
                	 <div style="text-align: center;" id="card-msg"></div>
                   ...
                   &nbsp;<a href=""><button class="btn btn-danger" style="font-size: 25px; width: 110px;">Clear</button></a> &nbsp;<button onclick="return cardCode()" class="btn btn-success" style="font-size: 25px; width: 110px;">Proceed</button>
  			    </div>
  			</div>
  		<div class="col-md-3">
  		</div>
